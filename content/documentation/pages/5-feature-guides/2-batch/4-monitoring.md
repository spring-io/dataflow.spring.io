...
To enable Micrometer’s Prometheus-RSocket meter registry for Spring Cloud Task application starters, start the Data Flow server with the following properties:
