...
To enable Wavefront for deployed streams, modify the file `src/kubernetes/server/server-config.yaml` making the following additions:
...
To enable Wavefront for deployed tasks, modify the file `src/kubernetes/server/server-config.yaml` making the following additions:
