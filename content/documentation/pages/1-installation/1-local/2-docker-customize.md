...
Data Flow is running inside of a Docker container, so the Docker container will will need access to your local file system in order to resolve the registration reference.
